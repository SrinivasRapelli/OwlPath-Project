...
public class NVRCustomExamPage {
	WebDriver driver;
	
	public NVRCustomExamPage(WebDriver driver) {
		this.driver = driver;
	}
...
//		element.click();
	...
	public void clickOnNVRSubject() {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		WebElement element = wait.until(ExpectedConditions.visibilityOfElementLocated(nvrSub));
		element.click();
	}
