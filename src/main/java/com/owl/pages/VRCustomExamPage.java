...
public class VRCustomExamPage {
	
	WebDriver driver;
	
	public VRCustomExamPage(WebDriver driver) {
		this.driver = driver;
	}
	...
	By loginbutton = By.xpath("(//button[text()='Login'])[1]");
	...
	public void clickOnVrSubject() {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		WebElement element = wait.until(ExpectedConditions.visibilityOfElementLocated(vrSub));
		element.click();
	}
	
	public void selectCompoundWordsStartPracticeButton() {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
